...
(function (document, window, $) {
    ...
    // -------------
    var editor;
    var mode = "default"; //default, add, edit
    (function ($) {
        $.ajax({
            url: "/UnitOfMeasure/GetRole",
            type: "GET",
            data: {},
            success: function (json) {
                ...
                var Table = {
                        ...
                        this.datatable = this.$table.DataTable({
                            ...
                            "columnDefs": [
                                ...
                                , {
                                    ...
                                    "width": "60px",
                                    "visible": json.ISCANEDIT || json.ISCANDELETE ? true : false,
                                    "targets": 4, "data": "SID", "render": function (data, type, full, meta) {
                                        return '<div class="SID" style="display:none;">' + data.SID + '</div>'
                                            + (json.ISCANEDIT ? '<a href="#" type="button" class="btn btn-sm btn-icon btn-pure btn-default on-default edit-row" data-toggle="tooltip" data-original-title="Edit"><i class="icon md-edit" aria-hidden="true"></i></a>' : '<img class="btn btn-sm btn-icon btn-pure btn-default on-default edit-row" /><i class="icon md-edit" aria-hidden="true"></i>')
                                            + (json.ISCANDELETE ? ' <a href= "#" type= "button" class="btn btn-sm btn-icon btn-pure btn-default on-default remove-row" data- toggle="tooltip" data- original - title="Remove" > <i class="icon md-delete" aria-hidden="true"></i></a > ' : '')
                                            + (json.ISCANADD || json.ISCANEDIT ? ' <a href="#" type= "button" class="btn btn-sm btn-icon btn-pure btn-default on-editing save-row" data-toggle="tooltip" data-original-title="Save" hidden><i class="icon md-check-all" aria-hidden="true"></i></a>' : '')
                                            + (json.ISCANADD || json.ISCANEDIT ? ' <a href="#" type= "button" class="btn btn-sm btn-icon btn-pure btn-default on-editing cancel-row" data-toggle="tooltip" data-original-title="Delete" hidden><i class="icon md-close" aria-hidden="true"></i></a>' : '');
                                    }
                                }
                            ],
                            select: {
                    ...
                    rowAdd: function () {
                        ...
                        data = this.datatable.row.add({ "SID": 0, "IDUOM": "", "UOMNAME": "", "ISACTIVE": 0 });
