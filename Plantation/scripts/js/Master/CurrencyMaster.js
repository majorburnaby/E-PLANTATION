...
(function (document, window, $) {
    ...
    (function ($) {
        ...
        editor = new $.fn.dataTable.Editor({
            ajax: "/CurrencyMaster/Data",
            table: "#tblcurrencymaster",
            fields: [{
                name: "IDCURRENCY"
            }, {
                name: "CURRENCYNAME"
        ...
        $('#tblcurrencymaster').on('click', 'tbody td', function (e) {
            if ($(this).index() < 2) {
        ...
        var Table = {
            ...
            rowAdd: function () {
                ...
                data = this.datatable.row.add({ "SID": 0, "IDCURRENCY": "", "CURRENCYNAME": "" });
            ...
            rowSave: function ($row) {
                ...
                if (values[0] === "" || values[1] === "") { //Empty Data Validation
                    ...
                    values[2].IDCURRENCY = values[0];
                    values[2].CURRENCYNAME = values[1];
                    this.datatable.row($row.get(0)).data(values[2]);

                    var currencymaster = {};
                    if (values[2].SID !== 0) {
                        currencymaster.SID = values[2].SID;
                        currencymaster.IDCURRENCY = values[0];
                        currencymaster.CURRENCYNAME = values[1];
                        $.ajax({
                            type: "POST",
                            url: "/CurrencyMaster/Edit",
                            data: '{currencymaster: ' + JSON.stringify(currencymaster) + '}',
                            contentType: "application/json; charset=utf-8",
                            dataType: "json"
                        });
                    } else {
                    ...
                    $('#tblcurrencymaster').DataTable().ajax.reload();
                }
            },
