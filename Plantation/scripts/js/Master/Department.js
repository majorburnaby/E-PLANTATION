    ...
    (function ($) {
        ...
        var Table = {
            ...
            rowAdd: function () {
                ...
                data = this.datatable.row.add({ "SID": 0, "IDDEPARTMENT": "", "DEPARTMENTNAME": "", "DESCRIPTION": "" });
            ...
            rowSave: function ($row) {
                ...
                if (values[0] === "" || values[1] === "" || values[3] === "") { //Empty Data Validation
                    bootbox.dialog({
                    ...
                    values[3].IDDEPARTMENT = values[0];
                    values[3].DEPARTMENTNAME = values[1];
                    values[3].DESCRIPTION = values[2];
                    this.datatable.row($row.get(0)).data(values[3]);

                    var department = {};
                    if (values[3].SID !== 0) {
                        department.SID = values[3].SID;
                        department.IDDEPARTMENT = values[0];
                        department.DEPARTMENTNAME = values[1];
                        department.DESCRIPTION = values[2];
                        $.ajax({
                            type: "POST",
                            url: "/Department/Edit",
