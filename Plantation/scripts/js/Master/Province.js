...
(function (document, window, $) {
    ...
    (function ($) {
        ...
        editor.field('PROVINCE.COUNTRY').input().addClass('form-control input-sm');
        //editor.field('IDPROVINCE').input().addClass('form-control input-block');
        //editor.field('PROVINCENAME').input().addClass('form-control input-block');
        ...
        $.getJSON('GetCountryList', function (json) {
            $.each(json, function (i, obj) {
                ...
                editor.field('PROVINCE.COUNTRY').update(option_country);
            });
        });

        // Activate the bubble editor on click of a table cell
        $('#tblprovince').on('click', 'tbody td', function (e) {
            if ($(this).index() < 3) {
        ...
        //          '<a href="#" type="button" class="btn btn-sm btn-icon btn-pure btn-default on-editing save-row" data-toggle="tooltip" data-original-title="Save" hidden><i class="icon md-check-all" aria-hidden="true"></i></a>',
        //          '<a href="#" type="button" class="btn btn-sm btn-icon btn-pure btn-default on-editing cancel-row" data-toggle="tooltip" data-original-title="Delete" hidden><i class="icon md-close" aria-hidden="true"></i></a>',
        //          '<a href="#" type="button" class="btn btn-sm btn-icon btn-pure btn-default on-default edit-row" data-toggle="tooltip" data-original-title="Edit" hidden><i class="icon md-edit" aria-hidden="true"></i></a>',
        //          '<a href="#" type="button" class="btn btn-sm btn-icon btn-pure btn-default on-default remove-row" data-toggle="tooltip" data-original-title="Remove" hidden><i class="icon md-delete" aria-hidden="true"></i></a>'
        //        ].join(' ');
        ...
        //            province.SID = values[0];
        //            province.IDPROVINCE = values[1];
        //            province.PROVINCENAME = values[2];
        //            province.COUNTRY = values[3];
        //            $.ajax({
        //                type: "POST",
        //                url: "/Province/Edit",
        //                data: '{province: ' + JSON.stringify(province) + '}',
