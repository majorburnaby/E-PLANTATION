        ...
        var Table = {
            ...
            build: function () {
                this.datatable = this.$table.DataTable({
                    //dom: "Blfrtip",
                    ajax: "/CustomerGroup/Data",
                    columns: [
                        { data: "SID" },
                        { data: "IDCUSTOMERGROUP" },
            ...
            rowAdd: function () {
                ...
                data = this.datatable.row.add({ "SID": 0, "IDCUSTOMERGROUP": "", "CUSTOMERGROUPNAME": "" });
            ...
            rowSave: function ($row) {
                ...
                if (values[0] === "" || values[1] === "") { //Empty Data Validation
                    ...
                    values[2].IDCUSTOMERGROUP = values[0];
                    values[2].CUSTOMERGROUPNAME = values[1];
                    this.datatable.row($row.get(0)).data(values[2]);

                    var customergroup = {};
                    if (values[2].SID !== 0) {
                        customergroup.SID = values[2].SID;
                        customergroup.IDCUSTOMERGROUP = values[0];
                        customergroup.CUSTOMERGROUPNAME = values[1];
                        $.ajax({
                            type: "POST",
