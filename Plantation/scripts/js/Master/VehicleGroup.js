    ...
    (function ($) {
        ...
        var Table = {
            ...
            rowAdd: function () {
                ...
                data = this.datatable.row.add({ "SID": 0, "IDVEHICLEGROUP": "", "VEHICLEGROUPNAME": "" });
            ...
            rowSave: function ($row) {
                ...
                if (values[0] === "" || values[1] === "") { //Empty Data Validation
                    ...
                    values[2].IDVEHICLEGROUP = values[0];
                    values[2].VEHICLEGROUPNAME = values[1];
                    this.datatable.row($row.get(0)).data(values[2]);

                    var vehiclegroup = {};
                    if (values[2].SID !== 0) {
                        vehiclegroup.SID = values[2].SID;
                        vehiclegroup.IDVEHICLEGROUP = values[0];
                        vehiclegroup.VEHICLEGROUPNAME = values[1];
                        $.ajax({
                            type: "POST",
                            url: "/VehicleGroup/Edit",
                    ...
                    $('#tblvehiclegroup').DataTable().ajax.reload();
                }
            },
