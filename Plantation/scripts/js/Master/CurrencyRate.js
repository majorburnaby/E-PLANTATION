    ...
    (function ($) {
        var EditableTable = {
            ...
            rowSave: function ($row) {
                ...
                var currencyrate = {};
                if (values[0]) {
                    currencyrate.SID = values[0];
                    currencyrate.CURRENCYMASTER = values[1];
                    currencyrate.RATE = values[2];
                    $.ajax({
                        type: "POST",
                        url: "/CurrencyRate/Edit",
                        data: '{currencyrate: ' + JSON.stringify(currencyrate) + '}',
                        contentType: "application/json; charset=utf-8",
                        dataType: "json"
                    });
                } else {
