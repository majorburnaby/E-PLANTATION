    ...
    (function ($) {
        var EditableTable = {
            ...
            rowSave: function ($row) {
                ...
                var controljob = {};
                if (values[0]) {
                    controljob.SID = values[0];
                    controljob.CONTROLSYSTEM = values[1];
                    controljob.ITEMCODE = values[2];
                    controljob.ITEMDESCRIPTION = values[3];
                    controljob.REMARKS = values[4];
                    controljob.ACTIVE = values[5];
                    controljob.ACTIVEDATE = values[6];
                    $.ajax({
                        type: "POST",
                        url: "/ControlJob/Edit",
