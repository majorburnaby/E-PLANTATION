    ...
    (function ($) {
        ...
        var Table = {
            ...
            rowAdd: function () {
                ...
                data = this.datatable.row.add({ "JOB": { "SID": 0, "IDJOB": "", "JOBNAME": "", "ACCOUNT": "", "JOBGROUP": "", "JOBTYPE": "" }, "JOBGROUP": { "JOBGROUPNAME": "" }, "JOBTYPE": { "JOBTYPENAME": "" } });
                ...
                $row.children('td').each(function (i) {
                    ...
                    if ($this.hasClass('actions')) {
                        ...
                        if ($(this).parent().children().index($(this)) === 3) {
                            $this.html('<select id="ddlJobGroup" class="form-control input-sm" data-plugin="select2" style="width: 100%"></select>');
                        ...
                        if ($(this).parent().children().index($(this)) === 4) {
                            $this.html('<select id="ddlJobType" class="form-control input-sm" data-plugin="select2" style="width: 100%"></select>');
                    ...
                    $("#ddlJobGroup").select2({ allowClear: true });
                    $("#ddlJobType").select2({ allowClear: true });
                });
            },
            ...
            rowSave: function ($row) {
                ...
                if (values[0] === "" || values[1] === "" || values[2] === "" || values[3] === "" || values[4] === "") {
                    ...
                    var job = {};
                    if (values[5].JOB.SID !== 0) {
                        job.SID = values[5].JOB.SID;
                        job.IDJOB = values[0];
                        job.JOBNAME = values[1];
                        job.ACCOUNT = values[2];
                        job.JOBGROUP = values[3];
                        job.JOBTYPE = values[4];
                        $.ajax({
                            type: "POST",
                            url: "/Job/Edit",
