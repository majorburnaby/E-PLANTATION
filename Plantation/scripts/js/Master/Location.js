...
(function (document, window, $) {
    ...
    (function ($) {
        ...
        $('#tbllocation').on('click', 'tbody td', function (e) {
            if ($(this).index() < 2) {
        ...
        var Table = {
            ...
            rowAdd: function () {
                ...
                data = this.datatable.row.add({ "SID": 0, "IDLOCATION": "", "LOCATIONNAME": "" });
            ...
            rowSave: function ($row) {
                ...
                if (values[0] === "" || values[1] === "") { //Empty Data Validation
                    ...
                    values[2].IDLOCATION = values[0];
                    values[2].LOCATIONNAME = values[1];
                    this.datatable.row($row.get(0)).data(values[2]);

                    var location = {};
                    if (values[2].SID !== 0) {
                        location.SID = values[2].SID;
                        location.IDLOCATION = values[0];
                        location.LOCATIONNAME = values[1];
                        $.ajax({
                            type: "POST",
                            url: "/Location/Edit",
