        ...
        var EditableTable = {
            ...
            rowSave: function ($row) {
                ...
                if (values[0]) {
                    ...
                    transportergroup.SID = values[0];
                    transportergroup.IDTRANSPORTERGROUP = values[1];
                    transportergroup.TRANSPORTERGROUPNAME = values[2];
                    transportergroup.CONTROLJOB = values[3];
                    $.ajax({
                        type: "POST",
