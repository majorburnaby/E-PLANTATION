        ...
        var EditableTable = {
                    ...
                    if ($this.hasClass('actions')) {
                        ...
                        if ($(this).parent().children().index($(this)) === 3) {
                            ...
                            $.getJSON('GetCostCenterList', function (json) {
                                $('#ddlCostCenter').empty();
                                $('#ddlCostCenter').append($('<option>').text("Select"));
            ...
            rowSave: function ($row) {
                ...
                if (values[0]) {
                    ...
                    fixedassetgroup.SID = values[0];
                    fixedassetgroup.IDFAGROUP = values[1];
                    fixedassetgroup.FAGROUPNAME = values[2];
                    fixedassetgroup.COSTCENTERID = values[3];
                    $.ajax({
                        type: "POST",
