...
(function (document, window, $) {
    ...
    (function ($) {
        ...
        $('#tblcountry').on('click', 'tbody td', function (e) {
            if ($(this).index() < 2) {
        ...
        var Table = {
            ...
            rowAdd: function () {
                ...
                data = this.datatable.row.add({ "SID": 0, "IDCOUNTRY": "", "COUNTRYNAME": "" });
            ...
            rowSave: function ($row) {
                ...
                if (values[0] === "" || values[1] === "") { //Empty Data Validation
                    ...
                    values[2].IDCOUNTRY = values[0];
                    values[2].COUNTRYNAME = values[1];
                    this.datatable.row($row.get(0)).data(values[2]);

                    var country = {};
                    if (values[2].SID !== 0) {
                        country.SID = values[2].SID;
                        country.IDCOUNTRY = values[0];
                        country.COUNTRYNAME = values[1];
                        $.ajax({
                            type: "POST",
                            url: "/Country/Edit",
