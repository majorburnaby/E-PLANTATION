    ...
    (function ($) {
        ...
        var Table = {
            ...
            rowAdd: function () {
                ...
                data = this.datatable.row.add({ "SID": 0, "IDREGION": "", "REGIONNAME": "" });
            ...
            rowSave: function ($row) {
                ...
                if (values[0] === "" || values[1] === "") { //Empty Data Validation
                    ...
                    values[2].IDREGION = values[0];
                    values[2].REGIONNAME = values[1];
                    this.datatable.row($row.get(0)).data(values[2]);

                    var region = {};
                    if (values[2].SID !== 0) {
                        region.SID = values[2].SID;
                        region.IDREGION = values[0];
                        region.REGIONNAME = values[1];
                        $.ajax({
                            type: "POST",
                            url: "/Region/Edit",
