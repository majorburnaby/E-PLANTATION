    ...
    (function ($) {
        ...
        var Table = {
            ...
            rowAdd: function () {
                ...
                data = this.datatable.row.add({ "SID": 0, "IDPOSITION": "", "POSITIONNAME": "", "DESCRIPTION": "", "STATUS": 0 });
            ...
            rowSave: function ($row) {
                ...
                if (values[0] === "" || values[1] === "" || values[2] === "") { //Empty Data Validation
                    bootbox.dialog({
                    ...
                    var position = {};
                    if (values[4].SID !== 0) {
                        position.SID = values[4].SID;
                        position.IDPOSITION = values[0];
                        position.POSITIONNAME = values[1];
                        position.DESCRIPTION = values[2];
                        position.STATUS = values[3];
                        $.ajax({
                            type: "POST",
                            url: "/Position/Edit",
