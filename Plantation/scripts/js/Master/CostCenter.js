    ...
    (function ($) {
        var EditableTable = {
            ...
            rowSave: function ($row) {
                ...
                var costcenter = {};
                if (values[0]) {
                    costcenter.SID = values[0];
                    costcenter.IDCOSTCENTER = values[1];
                    costcenter.COSTCENTERNAME = values[2];
                    costcenter.PARENTCOSTCENTER = values[3];
                    costcenter.COSTCENTERTYPE = values[4];
                    costcenter.ALIASNAME = values[5];
                    costcenter.ALLOCATIONTYPE = values[6];
                    costcenter.BUDGETTYPE = values[7];
                    costcenter.TRANSACTIONS = values[8];
                    costcenter.REMARKS = values[9];
                    costcenter.ACTIVE = values[10];
                    costcenter.ACTIVEDATE = values[11];
                    $.ajax({
                        type: "POST",
                        url: "/CostCenter/Edit",
                        data: '{costcenter: ' + JSON.stringify(costcenter) + '}',
                        contentType: "application/json; charset=utf-8",
                        dataType: "json"
                    });
                } else {
