    ...
    (function ($) {
        ...
        var Table = {
            ...
            rowAdd: function () {
                ...
                data = this.datatable.row.add({"SID": 0, "IDSTATION": "", "STATIONNAME": "", "ISACTIVE": 0 });
            ...
            rowSave: function ($row) {
                ...
                if (values[0] === "" || values[1] === "") { //Empty Data Validation
                    ...
                    var station = {};
                    if (values[3].SID !== 0) {
                        station.SID = values[3].SID;
                        station.IDSTATION = values[0];
                        station.STATIONNAME = values[1];
                        station.ISACTIVE = values[2];
                        $.ajax({
                            type: "POST",
                            url: "/Station/Edit",
                            data: '{station: ' + JSON.stringify(station) + '}',
                            contentType: "application/json; charset=utf-8",
                            dataType: "json"
                        });
                    } else {
