...
(function (document, window, $) {
    ...
    (function ($) {
        ...
        $('#tblparameter').on('click', 'tbody td', function (e) {
            if ($(this).index() < 2) {
        ...
        var Table = {
            ...
            rowAdd: function () {
                ...
                data = this.datatable.row.add({ "SID": 0, "IDPARAMETER": "", "PARAMETERNAME": "" });
            ...
            rowSave: function ($row) {
                ...
                if (values[0] === "" || values[1] === "") { //Empty Data Validation
                    ...
                    values[2].IDPARAMETER = values[0];
                    values[2].PARAMETERNAME = values[1];
                    this.datatable.row($row.get(0)).data(values[2]);

                    var parameter = {};
                    if (values[2].SID !== 0) {
                        parameter.SID = values[2].SID;
                        parameter.IDPARAMETER = values[0];
                    ...
                    $('#tblparameter').DataTable().ajax.reload();
                }
            },
