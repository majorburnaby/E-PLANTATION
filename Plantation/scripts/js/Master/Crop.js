...
(function (document, window, $) {
    ...
    (function ($) {
        ...
        $('#tblcrop').on('click', 'tbody td', function (e) {
            if ($(this).index() < 2) {
        ...
        var Table = {
            ...
            rowAdd: function () {
                ...
                data = this.datatable.row.add({ "SID": 0, "IDCROP": "", "CROPNAME": "" });
            ...
            rowSave: function ($row) {
                ...
                if (values[0] === "" || values[1] === "") { //Empty Data Validation
                    ...
                    values[2].IDCROP = values[0];
                    values[2].CROPNAME = values[1];
                    this.datatable.row($row.get(0)).data(values[2]);

                    var crop = {};
                    if (values[2].SID !== 0) {
                        crop.SID = values[2].SID;
                        crop.IDCROP = values[0];
